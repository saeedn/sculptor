...
// `defineFrontendConfig` in vite.base.config.ts. Renderer specifics: outDir
// .vite/build/renderer (electron-forge owns that path), and HMR gated under
// pytest so integration tests don't hit reload races.
